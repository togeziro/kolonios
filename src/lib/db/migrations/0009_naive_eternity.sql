...
--> statement-breakpoint
CREATE UNIQUE INDEX "payroll_records_id_employee_unique" ON "payroll_records" USING btree ("id","employee_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "employee_tax_profiles_employee_effective_unique" ON "employee_tax_profiles" USING btree ("employee_id","effective_from");
