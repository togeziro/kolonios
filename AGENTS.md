...
- `src/features/payroll/` — Payroll system (calculation engine, payslips, admin UI)
...
- `src/lib/db/payroll.ts` — Payroll data access with effective-date resolution (uses utils)
